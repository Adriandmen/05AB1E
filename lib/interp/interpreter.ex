...
defmodule Interp.Interpreter do
    ...
    def interp_nullary(op, stack, environment) do
        new_stack = case op do
            ...
            "žq̈" -> Stack.push(stack, 6.283185307179586) 
            ...
            "žs̈" -> Stack.push(stack, IntCommands.continued_fraction(fn x -> if x == 0 do 0 else 2 * x - 1 end end, fn y -> if y == 1 do 4 else IntCommands.pow(y - 1, 2) end end))            
